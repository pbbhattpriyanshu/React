...
function App() {
  ...
  return (
    <>
      ...
      {/* <button
        onClick={getData}
        className="bg-teal-700 text-white font-semibold text-xl px-6 py-3 rounded m-2 p-10 active:scale-90"
      >
        Get Data
      </button>
      <div className="bg-grey-800 p-5">
        {data.map(function (elem, idx) {
          return (
            <div
              key={idx}
              className="bg-white text-black flex item-center justify-center w-full px-7 py-6 rounded mb-2"
            >
